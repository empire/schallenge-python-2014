...
def handler_404(request, response):
 ...
 درخواست به وسیله ی thread های جداگانه ارسال می شه که برنامه ی اجرا کننده اش در فایل server/service.py قرارداده شده که کد کوتاه و جمع جوری نوشته وقسمت های دیگه برنامه توی ماژول های دیگه پخش شده اتد